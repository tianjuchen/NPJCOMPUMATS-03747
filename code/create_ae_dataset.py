...
def images_to_dataset(
    image_dir, output_path, img_size=(128, 128), normalize=True, test_split=0.2
):
    """
    ...
    if test_split > 0:
        X_train, X_test = train_test_split(
            images_array, test_size=test_split, random_state=42
        )
...
def create_dataset_from_images():
    ...
    output_file = "./../images/image_dataset_ss316_128_128.npz"
